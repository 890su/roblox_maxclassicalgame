...
StageWorldConfig.Locations = {
    ...
    Swamp = {
        ...
        Bounds = {
            Min = Vector3.new(-895.419, -203.563, -748.295),
...
StageWorldConfig.Stages = {
    ...
    SWAMP_JOURNEY = {
        ...
        Swamp = {
            ...
            GenerateRouteSteps = true,
            GenerateFallbackSteps = false,
            FallbackStepCount = 0,
            GenerateFogVisual = false,
            GeneratedFolderName = "GeneratedSwampKochki",
            RegenerateRouteSteps = true,
            RouteStepMinDistance = 8,
            RouteStepMaxDistance = 11,
            RouteSideJitter = 7,
            RouteForwardJitter = 2,
            StepSize = Vector3.new(5.5, 1.1, 5.5),
            StepSinkMinSeconds = 3,
            StepSinkMaxSeconds = 5,
            StepSinkDepth = 9,
            MaxGuideLeadSteps = 3,
            GuideHurryInterval = 4,
            RoutePoints = {},
            PathCorridors = {
                {
                    A = Vector3.new(-567.893, -203.563, -371.156),
                    B = Vector3.new(-521.592, -203.563, -579.802),
                },
                {
                    A = Vector3.new(-579.663, -203.563, -525.156),
                    B = Vector3.new(-895.419, -203.563, -587.618),
                },
                {
                    A = Vector3.new(-819.886, -203.563, -592.117),
                    B = Vector3.new(-869.845, -203.563, -748.295),
                },
            },
            FogPartNames = { "PoisonFog", "PoisonCloudTrap", "SwampFog" },
            FallPartNames = { "SwampFall", "SwampVoid" },
            TeleportOnFallParts = false,
            GuideNpcId = "DouDzouh",
            GuideWaitRadius = 8,
            GuideSafeRadius = 12,
            ...
            StepSafeRadius = 4.5,
            FogDamagePerTick = 5,
            FogDamageDistanceScale = 0.35,
            FogDamageMaxPerTick = 22,
            FogDamageInterval = 1,
...
function StageWorldConfig.GetSwampConfig()
    ...
    return {
        ...
        GenerateRouteSteps = s.GenerateRouteSteps,
        GenerateFallbackSteps = s.GenerateFallbackSteps,
        FallbackStepCount = s.FallbackStepCount,
        GenerateFogVisual = s.GenerateFogVisual,
        GeneratedFolderName = s.GeneratedFolderName,
        RegenerateRouteSteps = s.RegenerateRouteSteps,
        RouteStepMinDistance = s.RouteStepMinDistance,
        RouteStepMaxDistance = s.RouteStepMaxDistance,
        RouteSideJitter = s.RouteSideJitter,
        RouteForwardJitter = s.RouteForwardJitter,
        StepSize = s.StepSize,
        StepSinkMinSeconds = s.StepSinkMinSeconds,
        StepSinkMaxSeconds = s.StepSinkMaxSeconds,
        StepSinkDepth = s.StepSinkDepth,
        MaxGuideLeadSteps = s.MaxGuideLeadSteps,
        GuideHurryInterval = s.GuideHurryInterval,
        RoutePoints = s.RoutePoints,
        PathCorridors = s.PathCorridors,
        FogPartNames = s.FogPartNames,
        FallPartNames = s.FallPartNames,
        TeleportOnFallParts = s.TeleportOnFallParts,
        ...
        FogDamageDistanceScale = s.FogDamageDistanceScale,
        FogDamageMaxPerTick = s.FogDamageMaxPerTick,
